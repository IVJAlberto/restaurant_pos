...
const OrderDetails = () => {
    ...
    return(
        ...
        <div className="bg-zinc-200 dark:bg-stone-950 w-full md:w-6/12 absolute right-0 h-full overflow-auto">
            <div className="flex flex-col gap-2 h-full">
                <div className="max-h-20 flex flex-auto items-center justify-between p-5 bg-zinc-300 dark:bg-zinc-900">
