...
import { eliminarPlatillo, agregarPlatillo, eliminarTodosLosPlatillos } from "../../../../../slices/OrdersFeedSlice";
import { useDispatch } from "react-redux";

const DishOrder = ({ platillo }) => {
    ...
    return(
        <div className="rounded-2xl bg-zinc-400 dark:bg-zinc-800 py-3.5 px-5 space-y-5 shadow-md border border-zinc-400 dark:border-zinc-900">
            <div className="flex flex-col">
                <div className="flex flex-row justify-between">
                    <p className="text-black dark:text-white text-md font-medium">{platillo.nombre}</p>
                ...
                <p className="text-zinc-700 dark:text-zinc-500 text-md font-medium">$ {platillo.precio}</p>
            </div>
